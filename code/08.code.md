...
# create the bindep.txt file to add the required system packages
cat <<EOF > bindep.txt
openssh-clients
EOF
...
## Launching a Job Using from Your CI Pipelines
...
echo "$DatabasePassword" | gh secret set DATABASE_PASSWORD
```
